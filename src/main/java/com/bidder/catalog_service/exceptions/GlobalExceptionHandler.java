/* (C) 2026
bidder.app */
package com.bidder.catalog_service.exceptions;

import java.util.List;
import java.util.NoSuchElementException;

import com.bidder.catalog_service.models.response.ApiResponse;
import com.bidder.catalog_service.models.response.Message;
import com.bidder.catalog_service.models.response.MessageType;
